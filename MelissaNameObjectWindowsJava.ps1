# Name:    MelissaNameObjectWindowsJava
# Purpose: Use the Melissa Updater to make the MelissaNameObjectWindowsJava code usable
...
javac -cp mdName.jar MelissaNameObjectWindowsJava.java
jar cvfm MelissaNameObjectWindowsJava.jar manifest.txt *.class *.dll mdName.jar

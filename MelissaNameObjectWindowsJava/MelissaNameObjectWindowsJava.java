 ...
 * which the accompanying MelissaNameObjectWindowsJava.ps1 script downloads and
 * expands into com/melissadata on every run. mdNameJNI declares the native methods and
 * loads mdNameJavaWrapper.dll, the JNI shim that calls into mdName.dll.
 *
 * <p>Reference:
 * <ul>
 ...
 * </ul>
 */
public class MelissaNameObjectWindowsJava {
  ...
  public static void RunAsConsole(String license, String testName, String dataPath) throws IOException {
    System.out.println("\n\n=========== WELCOME TO MELISSA NAME OBJECT WINDOWS JAVA ============\n");
